...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/home/jarbo/.pyenv/versions/3.11.0/bin',
 'BINLIBDEST': '/home/jarbo/.pyenv/versions/3.11.0/lib/python3.11',
 'BLDLIBRARY': 'libpython3.11.a',
 'BLDSHARED': 'gcc -pthread -shared -L/home/jarbo/.pyenv/versions/3.11.0/lib '
              '-L/usr/local/openssl/lib '
              '-L/home/jarbo/.pyenv/versions/3.11.0/lib '
              '-L/usr/local/openssl/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/home/jarbo/.pyenv/versions/3.11.0/include '
                       '-I/usr/include/openssl',
 'CONFIGURE_LDFLAGS': '-L/home/jarbo/.pyenv/versions/3.11.0/lib '
                      '-L/usr/local/openssl/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/home/jarbo/.pyenv/versions/3.11.0' "
                "'--libdir=/home/jarbo/.pyenv/versions/3.11.0/lib' "
                "'--disable-shared' '--enable-optimizations' "
                "'--with-openssl=/usr/local/openssl' 'CXX=g++' "
                "'LDFLAGS=-L/home/jarbo/.pyenv/versions/3.11.0/lib "
                "-L/usr/local/openssl/lib' "
                "'LIBS=-L/home/jarbo/.pyenv/versions/3.11.0/lib' "
                "'CPPFLAGS=-I/home/jarbo/.pyenv/versions/3.11.0/include "
                "-I/usr/include/openssl'",
 'CONFINCLUDEDIR': '/home/jarbo/.pyenv/versions/3.11.0/include',
 'CONFINCLUDEPY': '/home/jarbo/.pyenv/versions/3.11.0/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/tmp/python-build.20241107183942.63069/Python-3.11.0/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/tmp/python-build.20241107183942.63069/Python-3.11.0/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/home/jarbo/.pyenv/versions/3.11.0/include '
             '-I/usr/include/openssl '
             '-I/home/jarbo/.pyenv/versions/3.11.0/include '
             '-I/usr/include/openssl',
 'CXX': 'g++ -pthread',
 ...
 'DESTDIRS': '/home/jarbo/.pyenv/versions/3.11.0 '
             '/home/jarbo/.pyenv/versions/3.11.0/lib '
             '/home/jarbo/.pyenv/versions/3.11.0/lib/python3.11 '
             '/home/jarbo/.pyenv/versions/3.11.0/lib/python3.11/lib-dynload',
 'DESTLIB': '/home/jarbo/.pyenv/versions/3.11.0/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/home/jarbo/.pyenv/versions/3.11.0/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/home/jarbo/.pyenv/versions/3.11.0/include '
                   '/home/jarbo/.pyenv/versions/3.11.0/include '
                   '/home/jarbo/.pyenv/versions/3.11.0/include/python3.11 '
                   '/home/jarbo/.pyenv/versions/3.11.0/include/python3.11',
 'INCLUDEDIR': '/home/jarbo/.pyenv/versions/3.11.0/include',
 'INCLUDEPY': '/home/jarbo/.pyenv/versions/3.11.0/include/python3.11',
 ...
 'LDFLAGS': '-L/home/jarbo/.pyenv/versions/3.11.0/lib -L/usr/local/openssl/lib '
            '-L/home/jarbo/.pyenv/versions/3.11.0/lib -L/usr/local/openssl/lib',
 'LDLIBRARY': 'libpython3.11.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -L/home/jarbo/.pyenv/versions/3.11.0/lib '
             '-L/usr/local/openssl/lib '
             '-L/home/jarbo/.pyenv/versions/3.11.0/lib '
             '-L/usr/local/openssl/lib',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/home/jarbo/.pyenv/versions/3.11.0/lib/python3.11',
 'LIBDIR': '/home/jarbo/.pyenv/versions/3.11.0/lib',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/jarbo/.pyenv/versions/3.11.0/lib/pkgconfig',
 'LIBPL': '/home/jarbo/.pyenv/versions/3.11.0/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.11.a',
 'LIBRARY_DEPS': 'libpython3.11.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lpthread -ldl -L/home/jarbo/.pyenv/versions/3.11.0/lib -lutil',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc -pthread',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/jarbo/.pyenv/versions/3.11.0/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/home/jarbo/.pyenv/versions/3.11.0/share/man',
 ...
 'OPENSSL_LDFLAGS': '-L/usr/local/openssl/lib',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                             ...
                             '-I/usr/include/openssl '
                             '-I/home/jarbo/.pyenv/versions/3.11.0/include '
                             '-I/usr/include/openssl -DPy_BUILD_CORE_BUILTIN',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -std=c11 '
                   ...
                   '-I/usr/include/openssl '
                   '-I/home/jarbo/.pyenv/versions/3.11.0/include '
                   '-I/usr/include/openssl -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/home/jarbo/.pyenv/versions/3.11.0/lib '
                    '-L/usr/local/openssl/lib '
                    '-L/home/jarbo/.pyenv/versions/3.11.0/lib '
                    '-L/usr/local/openssl/lib',
 'PY_CPPFLAGS': '-I. -I./Include -I/home/jarbo/.pyenv/versions/3.11.0/include '
                '-I/usr/include/openssl '
                '-I/home/jarbo/.pyenv/versions/3.11.0/include '
                '-I/usr/include/openssl',
 'PY_ENABLE_SHARED': 0,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/home/jarbo/.pyenv/versions/3.11.0/lib '
               '-L/usr/local/openssl/lib '
               '-L/home/jarbo/.pyenv/versions/3.11.0/lib '
               '-L/usr/local/openssl/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/home/jarbo/.pyenv/versions/3.11.0/lib '
                     '-L/usr/local/openssl/lib '
                     '-L/home/jarbo/.pyenv/versions/3.11.0/lib '
                     '-L/usr/local/openssl/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/home/jarbo/.pyenv/versions/3.11.0/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-lpthread -ldl -L/home/jarbo/.pyenv/versions/3.11.0/lib -lutil',
 'SHLIB_SUFFIX': '.so',
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './home/jarbo/.pyenv/versions/3.11.0',
 'WASM_STDLIB': './home/jarbo/.pyenv/versions/3.11.0/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/tmp/python-build.20241107183942.63069/Python-3.11.0',
 'abs_srcdir': '/tmp/python-build.20241107183942.63069/Python-3.11.0',
 'datarootdir': '/home/jarbo/.pyenv/versions/3.11.0/share',
 'exec_prefix': '/home/jarbo/.pyenv/versions/3.11.0',
 'prefix': '/home/jarbo/.pyenv/versions/3.11.0',
 'srcdir': '.'}
