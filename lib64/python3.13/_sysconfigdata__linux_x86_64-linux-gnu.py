...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/home/jarbo/.pyenv/versions/3.13.1/bin',
    'BINLIBDEST': '/home/jarbo/.pyenv/versions/3.13.1/lib/python3.13',
    'BLDLIBRARY': 'libpython3.13.a',
    'BLDSHARED': 'gcc -pthread -shared -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CONFIGURE_CPPFLAGS': '-I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include',
    'CONFIGURE_LDFLAGS': '-L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib',
    'CONFIGURE_LDFLAGS_NODIST': '-fno-semantic-interposition',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--prefix=/home/jarbo/.pyenv/versions/3.13.1' '--libdir=/home/jarbo/.pyenv/versions/3.13.1/lib' '--disable-shared' '--enable-optimizations' '--with-openssl=/usr/local/openssl' 'CXX=g++' 'PKG_CONFIG_PATH=/usr/local/sqlite/lib/pkgconfig' 'LDFLAGS=-L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib' 'LIBS=-L/home/jarbo/.pyenv/versions/3.13.1/lib' 'CPPFLAGS=-I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include'",
    'CONFINCLUDEDIR': '/home/jarbo/.pyenv/versions/3.13.1/include',
    'CONFINCLUDEPY': '/home/jarbo/.pyenv/versions/3.13.1/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/tmp/python-build.20250117174027.42688/Python-3.13.1/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/tmp/python-build.20250117174027.42688/Python-3.13.1/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include -I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include -I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include',
    'CXX': 'g++ -pthread',
    'DESTDIRS': '/home/jarbo/.pyenv/versions/3.13.1 /home/jarbo/.pyenv/versions/3.13.1/lib /home/jarbo/.pyenv/versions/3.13.1/lib/python3.13 /home/jarbo/.pyenv/versions/3.13.1/lib/python3.13/lib-dynload',
    'DESTLIB': '/home/jarbo/.pyenv/versions/3.13.1/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/home/jarbo/.pyenv/versions/3.13.1/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/home/jarbo/.pyenv/versions/3.13.1/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/home/jarbo/.pyenv/versions/3.13.1/include /home/jarbo/.pyenv/versions/3.13.1/include /home/jarbo/.pyenv/versions/3.13.1/include/python3.13 /home/jarbo/.pyenv/versions/3.13.1/include/python3.13',
    'INCLUDEDIR': '/home/jarbo/.pyenv/versions/3.13.1/include',
    'INCLUDEPY': '/home/jarbo/.pyenv/versions/3.13.1/include/python3.13',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'g++ -pthread -shared -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib',
    'LDFLAGS': '-L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib',
    'LDLIBRARY': 'libpython3.13.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -pthread -shared -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/home/jarbo/.pyenv/versions/3.13.1/lib/python3.13',
    'LIBDIR': '/home/jarbo/.pyenv/versions/3.13.1/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -fno-semantic-interposition -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include -I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/home/jarbo/.pyenv/versions/3.13.1/lib/pkgconfig',
    'LIBPL': '/home/jarbo/.pyenv/versions/3.13.1/lib/python3.13/config-3.13-x86_64-linux-gnu',
    'LIBPYTHON': '',
    'LIBRARY': 'libpython3.13.a',
    'LIBRARY_DEPS': 'libpython3.13.a',
    'LIBRARY_OBJS': '\\',
    'LIBRARY_OBJS_OMIT_FROZEN': '\\',
    'LIBS': '-lpthread -ldl -L/home/jarbo/.pyenv/versions/3.13.1/lib -lutil',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': 'gcc -pthread',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/home/jarbo/.pyenv/versions/3.13.1/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/home/jarbo/.pyenv/versions/3.13.1/share/man',
    'MIMALLOC_HEADERS': '\\',
    'MKDIR_P': '/bin/mkdir -p',
    ...
    'MODULE__HASHLIB_CFLAGS': '-I/usr/local/openssl/include',
    'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
    'MODULE__HASHLIB_LDFLAGS': '-L/usr/local/openssl/lib   -lcrypto',
    ...
    'MODULE__SQLITE3_CFLAGS': '-I/usr/local/sqlite/include   -I./Modules/_sqlite',
    ...
    'MODULE__SQLITE3_LDFLAGS': '-L/usr/local/sqlite/lib -lsqlite3',
    'MODULE__SQLITE3_STATE': 'yes',
    'MODULE__SRE_LDFLAGS': '',
    'MODULE__SSL_CFLAGS': '-I/usr/local/openssl/include',
    ...
    'MODULE__SSL_LDFLAGS': '-L/usr/local/openssl/lib  -lssl -lcrypto',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -fno-semantic-interposition -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include -I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib -fno-semantic-interposition',
    'PY_CPPFLAGS': '-I. -I./Include -I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include -I/home/jarbo/.pyenv/versions/3.13.1/include -I/usr/local/sqlite/include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 1,
    'PY_LDFLAGS': '-L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib',
    'PY_LDFLAGS_NODIST': '-fno-semantic-interposition',
    'PY_LDFLAGS_NOLTO': '-L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib -L/home/jarbo/.pyenv/versions/3.13.1/lib -L/usr/local/sqlite/lib',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/home/jarbo/.pyenv/versions/3.13.1/lib',
    ...
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-lpthread -ldl -L/home/jarbo/.pyenv/versions/3.13.1/lib -lutil',
    'SHLIB_SUFFIX': '.so',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './home/jarbo/.pyenv/versions/3.13.1',
    'WASM_STDLIB': './home/jarbo/.pyenv/versions/3.13.1/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 1,
    ...
    'abs_builddir': '/tmp/python-build.20250117174027.42688/Python-3.13.1',
    'abs_srcdir': '/tmp/python-build.20250117174027.42688/Python-3.13.1',
    'datarootdir': '/home/jarbo/.pyenv/versions/3.13.1/share',
    'exec_prefix': '/home/jarbo/.pyenv/versions/3.13.1',
    'prefix': '/home/jarbo/.pyenv/versions/3.13.1',
    'srcdir': '.',
}
